                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a style="width: 100px;text-align: center;margin-top: 5px" href="{{url('order/'.$order->id.'/ApproveOrder')}}" class="btn btn-primary" onclick="return confirm('Are you sure ?')">Approve</a>
                                </td>
