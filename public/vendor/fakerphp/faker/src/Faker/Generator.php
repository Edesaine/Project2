 ...
 *
 * @method string imageUrl($width = 640, $height = 480, $publisher = null, $randomize = true, $word = null, $gray = false, string $format = 'png')
 *
 * @property string $image
 *
 * @method string image($dir = null, $width = 640, $height = 480, $publisher = null, $fullPath = true, $randomize = true, $word = null, $gray = false, string $format = 'png')
 *
